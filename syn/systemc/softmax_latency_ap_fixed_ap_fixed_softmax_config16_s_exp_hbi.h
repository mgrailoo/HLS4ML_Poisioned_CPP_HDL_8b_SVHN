...
// ==============================================================
#ifndef __softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi_H__
#define __softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi_H__
...
struct softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi_ram) {
...
SC_MODULE(softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi) {
...
softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi_ram* meminst;


SC_CTOR(softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi) {
meminst = new softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi_ram("softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi_ram");
...
~softmax_latency_ap_fixed_ap_fixed_softmax_config16_s_exp_hbi() {
    delete meminst;
}
